...
const TripPlannerPage = () => {
  ...
  const handleCategoryClick = (category) => {
    if (category.route === "day-plan") {
      navigate(`/explore/${country}/day-plan`);
    } else {
    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <h1 style={{ 
          ...
          Trip Planner for {displayCountry}!
        </h1>
        ...
        <p style={{ 
          ...
          Plan your perfect trip to {displayCountry}!
        </p>
        ...
        <div style={{ marginTop: "20px" }}>
          ...
          <div style={{
            ...
            {categories.map((category, index) => (
              ...
              >
                <span style={{ fontSize: "2.5rem", marginBottom: "15px" }}>
                  {category.icon}
                </span>
